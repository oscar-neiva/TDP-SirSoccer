...
\begin{abstract}
	Neste \textit{Team Description Paper - TDP} são apresentados os resultados do trabalho realizado em 2016 pela equipe SIRSoccer. O \textit{paper} tem como objetivo descrever o desenvolvimento de uma plataforma de futebol de robôs da categoria IEEE \textit{Very Small Size Soccer - VSSS}, para participação na XIV Competiç\~ao Brasileira de Rob\'otica - CBR e na XV Competiç\~ao Latino Americana de Robótica - LARC. São descritos os trabalhos de todas as etapas de construção do time. Algumas seções estão um pouco mais detalhadas: \textit{Framework} e Transmissão, uma vez que estas foram as partes com maior evolução durantes os trabalhos este ano. 
\end{abstract}
